...
void AFirstPersonCharacter::BeginPlay()
{
	...
	FPGun->AttachToComponent(Mesh1P, FAttachmentTransformRules(EAttachmentRule::SnapToTarget, true), TEXT("GripPoint"));
	FPGun->AnimInstance = Mesh1P->GetAnimInstance();

	// Bind fire event
	
	InputComponent->BindAction("Fire", IE_Pressed, FPGun, &AGun::OnFire);
	//TODO: Move to gun class
